                ...
                <div class="span8">
                    ...
                    <article class="blog-post">
                        <div class="post-heading">
                            <h3><a href="{{url('/logement/residence')}}">{{$res->designation}}</a></h3>
                        </div>
                        <div class="row">
                            <div class="span8">
                                ...
                                <p>
                                    {{$res->description_simp}}
                                </p>
                                <a href="{{url('/logement/residence').'?sel='.$res->reference}}" class="btn btn-small btn-theme">Voir Plus</a>
                            </div>
                        </div>
                    </article>
                @endforeach
